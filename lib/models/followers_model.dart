...
//
//     final followersDataModel = followersDataModelFromJson(jsonString);

import 'dart:convert';

List<FollowersDataModel> followersDataModelFromJson(String str) => List<FollowersDataModel>.from(json.decode(str).map((x) => FollowersDataModel.fromJson(x)));

String followersDataModelToJson(List<FollowersDataModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class FollowersDataModel {
    ...
    factory FollowersDataModel.fromJson(Map<String, dynamic> json) => FollowersDataModel(
